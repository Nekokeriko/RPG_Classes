...
public class MeleeSkeleton extends AttackingFollowingMob {
    public MeleeSkeleton() {
        super(10);
        this.setSpeed(60.0F);
    ...
    public void init() {
        super.init();
        this.ai = new BehaviourTreeAI<>(this, new PlayerFollowerCollisionChaserAI<MeleeSkeleton>(576, new GameDamage(0), 0, 1000, 640, 64) {
            @Override
            public boolean attackTarget(MeleeSkeleton mob, Mob target) {
